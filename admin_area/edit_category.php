 ...
 if(isset($_GET['edit_category'])){
    ...
    //echo $edit_category;
    //query for fetching data from database for whatever id is clicked
    $get_categories="Select * from `categories` where category_id=$edit_category";
    $result=mysqli_query($con,$get_categories);
    $row=mysqli_fetch_assoc($result);
    $category_title=$row['category_title'];
    //echo $category_title; this will have the category title of whatever category edit is clicked.
 } 
  //checking if edit_cat is pressed then category_title should be updated
